...
// Motor Pins
#define MOTOR_IN1 14  //first
#define MOTOR_IN2 15  //second
#define MOTOR_IN3 13  //third
#define MOTOR_IN4 12  // forth
...
// Adjust this value (0-255) to control your overall speed
int MAX_SPEED = 150; 
int TURN_SPEED = 120; // Slightly slower for turns to keep them controlled
...
void goLeft() {
  ...
  analogWrite(MOTOR_IN1, 0);
  analogWrite(MOTOR_IN2, 0); 
  analogWrite(MOTOR_IN3, TURN_SPEED);
  analogWrite(MOTOR_IN4, 0);
...
void goRight() {
  ...
  analogWrite(MOTOR_IN1, TURN_SPEED);
  analogWrite(MOTOR_IN2, 0); 
  analogWrite(MOTOR_IN3, 0);
  analogWrite(MOTOR_IN4, 0);
...
void loop() {
  webSocket.loop();  // Must run constantly for handshake/reconnect
